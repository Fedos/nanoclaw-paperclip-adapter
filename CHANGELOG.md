...
- Paperclip adapter plugin (`type: "nanoclaw"`) that delivers Paperclip wakes to a nanoclaw-managed Claude Code container over signed HTTP and forwards the daemon's NDJSON transcript into the Paperclip run viewer.
