...
Paperclip adapter plugin that lets a [nanoclaw](https://github.com/qwibitai/nanoclaw)-managed agent container run as a first-class employee in a Paperclip company.
